<?php
    ...
    $sql = "SELECT * FROM `products` WHERE `category_sid` = '3' ORDER BY `sid` ASC;";
...
<!-- start of Note -->
	<ul class="bookshelf">
		...
		<?php while ($row = mysql_fetch_assoc($rs)): ?>
			<img src="../img/forPages/menu_note.svg" alt="" class="mobile_product">

			<li class="book">

				<a href="stationary_note_info.php?sid=<?= $row['sid'] ?>">
				...
				<div class="h_info">
					...
					<a class="moreinfo_link" href="stationary_note_info.php?sid=<?= $row['sid'] ?>"></a>
