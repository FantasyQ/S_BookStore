<?php
    ...
    $sql = "SELECT * FROM `products` WHERE `category_sid` = '2' ORDER BY `sid` ASC;";
    ...
    <div id="box1">
        ...
        <ul class="book_slider">
            ...
            <li class="book_li book_s01">
                ...
                <div class="book_pic pic01"><img src="../img/slider2/1-01.png"></div>

                <div class="text_smallcontent1">

                    <div class="book_text text01">
                        <div class="text_words01"><img src="../img/slider2/1-05.png"><a href="book_art_info.php?sid=37" class="text_btn1"><img
            ...
            <li class="book_li book_s02">
                <div class="book_pic pic02"><img src="../img/slider2/1-02.png"></div>

                <div class="text_smallcontent1">

                    <div class="book_text text02">
                        <div class="text_words02"><img src="../img/slider2/1-06.png"><a href="book_art_info.php?sid=58" class="text_btn1"><img
                                src="../img/slider/1-09.png"></a></div>
            ...
            <li class="book_li book_s03">
                <div class="book_pic pic03"><img src="../img/slider2/1-03.png"></div>

                <div class="text_smallcontent1">

                    <div class="book_text text03">
                        <div class="text_words03"><img src="../img/slider2/1-07.png"><a href="book_art_info.php?sid=65" class="text_btn1"><img
                                src="../img/slider/1-09.png"></a></div>
            ...
            <li class="book_li book_s04">
                <div class="book_pic pic04"><img src="../img/slider2/1-04.png"></div>

                <div class="text_smallcontent1">

                    <div class="book_text text04">
                        <div class="text_words04"><img src="../img/slider2/1-08.png"><a href="book_art_info.php?sid=73" class="text_btn1"><img
                                src="../img/slider/1-09.png"></a></div>
    ...
    <div id="box2">
        ...
        <ul class="bookshelf">
            ...
            <?php while ($row = mysql_fetch_assoc($rs)): ?>
                <img src="../img/forPages/menu_art.svg" alt="" class="mobile_product">
                <li class="book">

                    <a href="book_art_info.php?sid=<?= $row['sid'] ?>">
                    ...
                    <div class="h_info">
                        ...
                        <p>NT$ <?= $row['price'] ?></p>
                        <a class="moreinfo_link" href="book_art_info.php?sid=<?= $row['sid'] ?>">
                        </a>
